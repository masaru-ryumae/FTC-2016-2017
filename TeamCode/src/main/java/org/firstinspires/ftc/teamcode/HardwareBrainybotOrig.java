 ...
 * See PushbotTeleopTank_Iterative and others classes starting with "Minabot" for usage examples.
 *
 ...
 * Motor channel:  Turntable drive motor:    "table_arm"
 * Servo channel:  Servo to open left claw:  "left_hand"
 * Servo channel:  Servo to open right claw: "right_hand"
 */
public class HardwareBrainybotOrig
{
    ...
    public static final double TABLE_RIGHT_POWER   =   1.0 ;
